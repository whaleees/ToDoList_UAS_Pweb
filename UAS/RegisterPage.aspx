...
<body class="bg-gray-800 h-screen flex items-center justify-center">
    <form id="form1" runat="server" class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <asp:Label ID="MessageLabel" runat="server" CssClass="text-red-500 mb-4 block" Text="" Visible="false"></asp:Label>

        <!-- Username -->
        <div class="mb-4">
            <label for="username" class="block text-gray-700 font-semibold text-md mb-2">Username</label>
            <asp:TextBox ID="Username" runat="server" placeholder="Enter your username" CssClass="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600" required />
        </div>

        <!-- Email -->
        <div class="mb-4">
            <label for="email" class="block text-gray-700 font-semibold text-md mb-2">Email</label>
            <asp:TextBox ID="Email" runat="server" placeholder="Enter your email" type="email" CssClass="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600" required />
        </div>
        ...
        <div class="mb-6">
            ...
            <asp:TextBox ID="Password" runat="server" TextMode="Password" placeholder="Enter your password" 
                ...
                CssClass="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600" required />
        </div>
